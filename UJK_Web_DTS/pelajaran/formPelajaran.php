                ...
                <div class="containerForm">
                    ...
                    <form action='insert.php' method='POST'>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Kode Pelajaran" name="kode">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nama Pelajaran</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Nama Pelajaran" name="nama_pelajaran">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Semester</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Semester" name="semester">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Jam Pelajaran</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Jam Pelajaran" name="jp">
                        </div>
